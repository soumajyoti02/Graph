...
We will be solving it using the DFS traversal technique. DFS goes in-depth, i.e., 
...
---> Make sure to carry a visited array(all elements are initialized to 0) and a stack data structure, 
